...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      <div
        className="cutstomer-container dashboard_section"
      ...
      >
        <div className="cutstomer-header">
          ...
          <div className="row dashboard_info_row">
            <div
              className="col-xl-2 col-5 m-2 frist_info_rectangle"
              data-aos="fade-up"
        ...
        <div className="container chart_Admin_section">
          <div className="row charts_Admin_Info">
            <div
              className="col-lg-5 col-11 m-2 frist_chart_Admin"
              data-aos="fade-right"
              data-aos-easing="linear"
              data-aos-duration="800"
            >
            ...
            >
              <div className="container frist_chart_top">
                <div className="row justify-content-between mt-4">
                  <h5 className="col-xl-6 col-lg-3 col-4">
        ...
        <div className="container mt-5 Last_dashboard_section">
          <div className="row Last_dashboard_section_space ">
            <div
              className="col-lg-5 col-11 m-2 rr"
              ...
              <div className="container Right_Side_Last_dashboard_section">
                <div className="row Right_Side_Last_dashboard_section_content">
                  <div className="col-6">
                    <div className="row">
                      <div className="col-3">
                        <img src="./icons/profit.png" alt="profit" />
                      </div>
