...
const Setting = () => {
  return (
    <>
      <Sidebar />
      <div className="cutstomer-container account">
        ...
        <div className="container mb-4" style={{ marginTop: "-50px" }}>
          <div className="row">
            <div className="col-lg-5 col-12 sett-left-side me-3 mb-4 ms-lg-5"  data-aos="fade-right"
            ...
            <div className="col-lg-5 col-12  me-3 mb-4 "  data-aos="fade-left"
              data-aos-easing="linear"
              data-aos-duration="800">
              <div className="container">
              ...
              data-aos-duration="800">
                  <div className="col-12">
                    ...
                    <div className="row">
                      <div className="col-5">
                        <label className="lapelcolor mb-1">Language</label>
                        <select
                      ...
                      <div className="col-5">
                        <label className="lapelcolor mb-1">Currency</label>
                        <select
                          className="form-select form-select-lg mb-3 "
                          aria-label=".form-select-lg example"
                        >
            ...
            <div className="col-lg-10 col-12 secendsec me-3 mb-4 ms-lg-5"  data-aos="fade-up"
              data-aos-anchor-placement="top-bottom"
              data-aos-duration="800">
