...
const MyAccount = () => {
  ...
  const validatePhone = (value) => {
    ...
    if (value == "") {
      ...
      setPhoneErrorMessage(
        "Phone number should start with 011, 010, 012, or 015"
      );
    } else {
      setPhoneErrorMessage("");
    }
  ...
  useEffect(() => {
    ...
    const fetchUserProfiles = async () => {
      try {
        const response = await axiosInstance.get(
          `/user_api/${userId}/userprofile/get`
        );
    ...
    const fetchUserImage = async () => {
      try {
        const response = await axiosInstance.get(
          `/imageupload/${userId}/imageupload/`
        );
    ...
    const updateUserProfile = async () => {
      try {
        ...
        const res = await axiosInstance.put(
          `/user_api/${userId}/userprofile/update`,
          requestData
        );
    ...
    if (file) {
      ...
      try {
        ...
        const res = await axiosInstance.patch(
          `/imageupload/${userId}/imageupload/${userId}/`,
          formData
        );
        // toast.success('Updated user profile successfully updated');
      } catch (error) {
    ...
    <>
      ...
      <div className="cutstomer-container account">
        ...
        <div className="container  mb-4 " style={{ marginTop: "-50px" }}>
          <div className="row">
            <div
              className="col-lg-5 col-12 acc-left-side me-3 mb-4 ms-lg-5"
              data-aos="fade-right"
            ...
            <div
              className="col-lg-5 col-12 acc-left-side mb-3"
              data-aos="fade-left"
              data-aos-easing="linear"
              data-aos-duration="800"
            >
