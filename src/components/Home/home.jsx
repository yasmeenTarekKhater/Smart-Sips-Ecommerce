  ...
  render() {
    return (
      <>
        <NavBar />
        {/* ------------------------start Header----------------------------- */}
        <header className="container" style={{ marginTop: "100px" }}>
          <div className="row">
            <div
              className="header_leftSide col-lg-5 col-md-6 col-12"
              // data-aos="fade-up"
              data-aos="zoom-out"
            ...
            >
              ...
              <h1>
                We Give Preference For Your Water.<br></br> Monitoring ,Analysis
                And Accuracy.
              </h1>
              ...
              <button
                aria-label="More"
                type="button"
                className="btn header_button"
              >
                <a href="#/">More</a>
              </button>
            </div>
            <div
              className="header_rightSide col-lg-5 col-md-3 col-12"
              // data-aos="fade-left"
              data-aos="fade-down"
              data-aos-easing="linear"
              data-aos-duration="1000"
        ...
        <section className="best_Advantages h-auto">
          ...
          <div className="container">
            <div className="row justify-content-between">
              <div
                className="col-md-2 Adv_content"
                data-aos="fade-up"
                data-aos-easing="linear"
                data-aos-duration="800"
              >
              ...
              >
                ...
                <p className="Adv_p">
                  The Device Monitors Changes in Water Quality And Sends Alerts
                  to the User.
                </p>
              </div>
              {/* --------------------------third  adv_content-------------------- */}
        ...
        <section className="Easy_Fast container h-auto">
          <div className="row justify-content-between">
            <div
              className="Easy_Fast_LeftSide col-lg-6 col-12 "
              data-aos="fade-up"
              data-aos-easing="linear"
              data-aos-duration="800"
            >
            ...
            <div
              className="Easy_Fast_RightSide col-md-6 col-12"
              // data-aos="fade-left"
              data-aos="fade-down"
              data-aos-easing="linear"
              data-aos-duration="800"
        ...
        <div className="container download-section">
          <div className="row">
            ...
            {/** End of explain */}
            <div
              className="col-lg-6 col-sm-12 download-image"
              data-aos="fade-left"
              data-aos-easing="linear"
              data-aos-duration="800"
            >
        ...
        <div className="container comments-section">
          <div className="row">
            ...
            {/** first col */}
            <div
              className="col-lg-6 col-sm-12 people-comment"
              data-aos="fade-left"
              data-aos-easing="linear"
              data-aos-duration="800"
            >
        ...
        <div
          className="container subscribe-section"
          data-aos="zoom-in"
          data-aos-easing="linear"
          data-aos-duration="800"
        >
