        ...
        return (
          <div className="product_Contant" key={p.id}>
            <div className="product_Image">
              <img src={p.image} alt="image"  data-aos="zoom-in"
            ...
            <div className="container-fluid product_description">
              <div className="row">
                ...
                <div className="col-6 container product_Icons_Container">
                  <div className="row">
                    <div
                      className="favourite_Product col-md-5 col-8"
                      data-aos="zoom-out"
                      data-aos-duration="2200"
                    >
                      <a href="#/" onClick={() => handleWishList(p.id)}>
                        <FaRegHeart />
                      </a>
                    </div>
                    <div
                      className="product_Cart col-md-5 col-8"
                      data-aos="zoom-out"
                      data-aos-duration="2200"
                    >
                      <a
