...
const ProductDetail = () => {
  ...
  const handleWishList = (p_id) => {
    axiosInstance
      .post("/products_api/wishlist/add", {
        product: [p_id],
    ...
    <>
          ...
          <div className="row">
            <div className="headShop-title col-md-6 col-sm-12">
              <h1 data-aos="zoom-out" data-aos-duration="2000">
                We Give Preference <br />
                For Your Water .<br /> Monitoring Analysis And Accuracy.
              </h1>
            </div>
      ...
      <div className="product_detail_section container ">
        {products.map((p) => {
          return (
            <div className="row">
              <div className="product_detail_section_left col-lg-4 col-10" data-aos="zoom-in"
              data-aos-easing="linear"
              data-aos-duration="800">
                <img src={p.image} alt="ourproduct" />
              </div>
              <div className="product_detail_section_right col-lg-6 col-10" data-aos="fade-left"  data-aos-easing="linear"
              data-aos-duration="800">
                <h4 className="product_detail_section_right_title">
                  {p.title}
                </h4>
                <p className="product_detail_section_right_category">
                  {p.category === 1
                    ? "Accessories"
                    : p.category === 2
                    ? "Device"
                ...
                <p className="product_detail_section_right_description">
                  {p.descriptio ? p.descriptio : p.title}
                </p>
                <div className="product_detail_section_right_available container">
                  <div className="row">
                    <div className="col-7">
                      <p className="product_detail_section_right_p">
                        {p.stock > 0 ? "Available In Stock" : "Out of stock"}
                      </p>
                    </div>
                    <div className="col-5 container">
                      <div className="row justify-content-around">
                        ...
                        <div className="col-5 d-flex justify-content-between product_detail_section_right_QTY">
                          ...
                          <p
                            className="QTYnegative"
                            onClick={() => {
                              qtyCountMins(countqty);
                            }}
                          >
                            -
                          </p>
