...
const Cart = () => {
  ...
  const deleteCart = (cart_Id) => {
    ...
    axiosInstance
      .delete(`/order_api/cart/delete/${cart_Id}`, {
        headers: {
  ...
  const deleteCartItem = (itemId) => {
    const authToken = localStorage.getItem("token");
    axiosInstance
      .delete(`order_api/item/cart/delete/${itemId}`, {
        headers: {
          Authorization: `Bearer ${authToken}`, // Include the authentication token in the request headers
        },
      })
  ...
  const updateCartQty = (itemId, productId, updatedQuantity) => {
    axiosInstance
      .put(`order_api/item/cart/update/${itemId}`, {
        product: productId,
        qnt: updatedQuantity,
      })
      .then((res) => {
        ...
        <div className="row">
          <div className="cart col-xl-9 col-lg-8">
            ...
            {itemsState.map((items, index) => (
              <div key={index} className="cart__container"   data-aos="zoom-in"
                          ...
                          <div className="col-md-2 cart-count ">
                            <div className="m-auto ">
                              ...
                              <button
                                ...
                                className="mins"
                                onClick={() => {
                                  qtyCountMins(id, product.id, qnt);
                                }}
                              >
                                -
                              </button>
          ...
          <div className="summary-cart col-lg-4 col-md-5 col-7 col-xl-3">
            ...
            <div className="summary-details" data-aos="fade-up" data-aos-easing="linear"
